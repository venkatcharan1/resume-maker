        ...
        <div className="mx-auto flex h-full min-h-[calc(100vh-5rem)] max-w-screen-xl flex-col-reverse items-center justify-center gap-8 overflow-hidden px-3 py-6 text-center md:flex-row md:justify-between md:text-left">
            <div className="">
                ...
                {/* <p className="mt-3 max-w-screen-sm text-sm text-gray-300 md:mt-10 md:text-lg">
                    Welcome to ResumeWithV! Making a great resume is easy here. Our tool helps you create a ATS friendly
                    resumes.{' '}
                    <span className="hidden md:inline">
                        It makes sure you look good to employers. Say bye-bye to resume worries and hello to ResumeWithV.
                        Start now and get closer to your dream job!
                    </span>
                </p> */}
                <p className="mt-3 max-w-screen-sm text-sm text-gray-300 md:mt-10 md:text-lg">
                ResumeWithV is an ATS-friendly resume maker designed to simplify the process of creating professional
                    <span className="hidden md:inline">
                        resumes without the hassle of login or sign-up. With ResumeWithV, users can easily input their
